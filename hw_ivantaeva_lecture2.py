...
while a not in m_num:
    print("Число должно быть от 1 до 99.")
    
    a = input("Введите число от 1 до 99: ")
    
else:
    ml_num = m_num.index(a)
    result = p_num[ml_num]
    print("Ваше число - ", result, ", обращайтесь!")
